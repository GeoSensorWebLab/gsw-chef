...
default["postgresql"]["settings"]["defaults"]["data_directory"] = "/tiledb/postgresql/12/main"
default["postgresql"]["settings"]["defaults"]["hba_file"] = "/etc/postgresql/12/main/pg_hba.conf"
default["postgresql"]["settings"]["defaults"]["ident_file"] = "/etc/postgresql/12/main/pg_ident.conf"
default["postgresql"]["settings"]["defaults"]["external_pid_file"] = "/var/run/postgresql/12-main.pid"
...
default["postgresql"]["settings"]["defaults"]["cluster_name"] = "12/main"

default["postgresql"]["settings"]["defaults"]["stats_temp_directory"] = "/var/run/postgresql/12-main.pg_stat_tmp"
