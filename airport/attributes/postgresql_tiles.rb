...
default[:postgresql][:settings][:tiles][:shared_buffers] = "4GB"
...
default[:postgresql][:settings][:tiles][:effective_io_concurrency] = 0
...
default[:postgresql][:settings][:tiles][:effective_cache_size] = "6GB"
