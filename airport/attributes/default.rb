...
###################################
# This location is Northern Canada
default['maps_server']['viewers']['latitude'] = 67
default['maps_server']['viewers']['longitude'] = -100
...
default['postgresql']['conf']['data_directory'] = '/srv/postgresql/11/main'
...
default['postgresql']['import-conf']['effective_io_concurrency'] = 0
...
# default['postgresql']['import-conf']['max_wal_size'] = '1GB'
...
# But up to 32GB should be fine: http://thebuild.com/blog/2017/06/09/shared_buffers-is-not-a-sensitive-setting/
# 25% of max RAM is okay.
default['postgresql']['tile-conf']['shared_buffers'] = '4GB'
...
# Use 0 if you have spinning hard disks and not SSDs.
# Use the same Queue Depth as your storage device.
default['postgresql']['tile-conf']['effective_io_concurrency'] = 0
