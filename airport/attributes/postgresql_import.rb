...
default[:postgresql][:settings][:import][:shared_buffers] = "2GB"
...
default[:postgresql][:settings][:import][:effective_io_concurrency] = 0
...
default[:postgresql][:settings][:import][:effective_cache_size] = "6GB"
